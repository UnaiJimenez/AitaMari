        ...
        <form class="row g-3 col-6" action= "ModificarVoluntario" style="background-color: #bebebe; border-radius: 2%;">
            <div class="col-12">
                ...
                <input type="hidden" name="id" value="${voluntario.id}"/>
						Nombre: <input type="text" name="nombre" value="${voluntario.nombre}"/>
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
                <a href="IndexVoluntarios"><button type="button" class="btn" style="background-color: white; margin: 2%;"><b>Modificar</b></button></a>
            </div>
        </form>
    </div> 
