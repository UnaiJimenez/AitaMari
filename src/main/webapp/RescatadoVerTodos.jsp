				...
				<div class="container-fluid" style="background-color: lightgray;">
					...
					<div>
						<ul class="navbar-nav contenidoBarraHorizontalDerecha">
							<li class="nav-item insertar"><a class="nav-link" aria-current="page" href="InsertarRescatado">Insertar Rescatados - <img class="fotoInsertar" src="Insertar.png" alt="insertar"></a></li>
