        ...
        <div>
            <nav class="navbar navbar-expand-lg bg-body-tertiary p-0">
                <div class="container-fluid" style="background-color: lightgray;">
                    ...
                    <ul class="navbar-nav">
                      <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="IndexFichaMedica" style="margin-right: 20px;"><img src="Fotos/IconoInicio.png" alt="icono de inicio" width="30px" height="25px"></a>
                      </li>
                    </ul> 
                </div>
              </nav>
   ...
   <div class="formulario" style="margin-top: 5%; margin-left: 35%;">
        <form class="row g-3 col-6" action= "ModificarFichaMedica" method="post" style="background-color: #bebebe; border-radius: 2%;">
           ...
           <div style="display: flex; justify-content: flex-end;">
			<div style="margin: 2%">
   				<form action="ModificarFichaMedica" method="post" style="margin: 2%">
    				<input type="hidden" name="id" value="${fichaMedica.id}"/>
			...
			<div style="margin: 2%">
				<form action="ModificarFichaMedica" method="post">
    				<input type="hidden" name="id" value="${fichaMedica.id}"/>
