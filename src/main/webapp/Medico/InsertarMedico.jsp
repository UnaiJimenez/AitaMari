...
<body style="background-color: #ececec;">
  <header>
        <div>
            <nav class="navbar navbar-expand-lg bg-body-tertiary p-0">
                <div class="container-fluid" style="background-color: lightgray;">
                    ...
                    <ul class="navbar-nav">
                      <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="IndexMedico" style="margin-right: 20px;"><img src="Fotos/IconoInicio.png" alt="icono de inicio" width="30px" height="25px"></a>
                      </li>
                    </ul> 
                </div>
              </nav>
        ...
        <form class="row g-3 col-6" action= "InsertarMedico" method="post" style="background-color: #bebebe; border-radius: 2%;">
			...
			<div style="margin: 2%">
   				<form action="InsertarMedico" method="post" style="margin: 2%">
			...
			<div style="margin: 2%">
				<form action="InsertarMedico" method="post">
    				<input type="hidden" name="id" value="${medico.id}"/>
