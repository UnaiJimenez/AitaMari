		...
		<div>
			<nav class="navbar navbar-expand-lg bg-body-tertiary p-0">
				<div class="container-fluid" style="background-color: lightgray;">
					...
					<ul class="navbar-nav">
						<li class="nav-item">
							<a class="nav-link" aria-current="page" href="InsertarVoluntario" style="margin-right: 20px;">Insertar datos - <img src="Insertar.png" alt="insertar" width="30px" height="30px"></a>
						</li>
						<li class="nav-item">
