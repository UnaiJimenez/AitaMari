...
<head>
    ...
    <title>Modificar Rescatado</title>
<body style="background-color: #ececec;">
  <header>
   ...
   <div class="formulario" style="margin-top: 5%; margin-left: 35%;">
        <form class="row g-3 col-6" action= "ModificarRescatado" method="post" style="background-color: #bebebe; border-radius: 2%;">
            <div class="col-12">
                <input type="hidden" name="id" value="${rescatado.id}"/>
                
						 <label for="Nombre" class="form-label">Nombre</label>
                <input type="text" class="form-control" name="nombre" placeholder="Nombre" value="${rescatado.nombre}">
            </div>
            <div class="col-12">
			...
			<div style="margin: 2%">
   				<form action="ModificarRescatado" method="post" style="margin: 2%">
    				<input type="hidden" name="id" value="${rescatado.id}"/>
			...
			<div style="margin: 2%">
				<form action="ModificarRescatado" method="post">
    				<input type="hidden" name="id" value="${rescatado.id}"/>
