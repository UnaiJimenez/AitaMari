				...
				<div class="container-fluid" style="background-color: lightgray;">
					...
					<div>
						<ul class="navbar-nav contenidoBarraHorizontalDerecha">
							<li class="nav-item insertar"><a class="nav-link" aria-current="page" href="InsertarVoluntario">Insertar Voluntarios - <img class="fotoInsertar" src="Fotos/Insertar.png" alt="insertar"></a></li>
					...
					<tbody>
						<c:forEach items="${voluntarios}" var="voluntario">
							<tr>
								...
								<td class="botones">
									<a class="nav-link" aria-current="page" href="ModificarVoluntario?id=${voluntario.id}"><img src="Fotos/modificar.png" alt="modificar" height="30px" width="30px"></a>
									<a class="nav-link" aria-current="page" href="EliminarVoluntario?id=${voluntario.id}"><img src="Fotos/eliminar.png" alt="eliminar" height="30px" width="30px"></a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
